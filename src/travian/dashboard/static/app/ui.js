...
export const state = {
  ...
  analysisState: {
    ...
    metric: "population",
    alliance: "combined",
    // One range per historical tab — never a shared global window. Each
    // entry: { mode: "days"|"custom", days: 7|30|60, from, to }.
    ranges: {
      regions: { mode: "days", days: 7, from: null, to: null },
      alliances: { mode: "days", days: 7, from: null, to: null },
      changes: { mode: "days", days: 7, from: null, to: null },
      events: { mode: "days", days: 7, from: null, to: null },
      wars: { mode: "days", days: 7, from: null, to: null },
      compare: { mode: "days", days: 7, from: null, to: null },
      watch: { mode: "days", days: 7, from: null, to: null },
    },
    region: null,
    eventsLimit: 200,
    warsPayload: null,
